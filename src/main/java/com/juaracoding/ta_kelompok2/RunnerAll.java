...
import com.juaracoding.ta_kelompok2.config.ConfigSupport;
import com.juaracoding.ta_kelompok2.impl.irfan.VerifikatorFinanceOutlineRunner;
...
//        ConfigSupport.getArgsRunner(args);
        try {
            Main.main(new String[]
                    {
                            "-g","com.juaracoding.ta.kelompok2.impl.irfan",
                            "classpath:features/irfan/",
                            "-p","pretty",
